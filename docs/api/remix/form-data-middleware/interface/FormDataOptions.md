...
source: https://github.com/remix-run/remix/blob/main/packages/form-data-middleware/src/lib/form-data.ts#L26
---
...
Options for the [`formData`](/api/remix/form-data-middleware/function/formData/) middleware.
