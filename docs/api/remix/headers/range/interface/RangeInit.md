---
title: RangeInit
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/headers/src/lib/range.ts#L6
---
...
Initializer for a [`Range`](/api/remix/headers/range/class/Range/) header value.
