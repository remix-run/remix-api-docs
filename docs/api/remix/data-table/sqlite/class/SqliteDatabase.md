...
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/data-table-sqlite/src/lib/database.ts#L10
---
...
A [`Database`](/api/remix/data-table/class/Database/) backed by SQLite.

## Signature

```ts
class SqliteDatabase {
  constructor(input: SqliteDatabaseClient | SqliteDatabaseConfig, options: DatabaseOptions): SqliteDatabase
  ...
  transaction<result>(callback: (database: Database<"sqlite">) => Promise<result>, options: TransactionOptions): Promise<result>
