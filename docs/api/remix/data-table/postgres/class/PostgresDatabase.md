...
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/data-table-postgres/src/lib/database.ts#L14
---
...
A [`Database`](/api/remix/data-table/class/Database/) backed by PostgreSQL.

## Signature

```ts
class PostgresDatabase {
  constructor(input: PostgresDatabaseInput, options: PostgresDatabaseOptions): PostgresDatabase
  ...
  transaction<result>(callback: (database: Database<"postgres">) => Promise<result>, options: TransactionOptions): Promise<result>
