---
title: table
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/data-table/src/lib/table.ts#L718
---
...
function table<
  ...
  primaryKey extends string | readonly ColumnNameFromColumns<columns>[] | undefined,
>(
