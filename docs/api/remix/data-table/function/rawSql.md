---
title: rawSql
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/data-table/src/lib/sql.ts#L82
---
...
SQL text containing placeholders expected by the target database.
