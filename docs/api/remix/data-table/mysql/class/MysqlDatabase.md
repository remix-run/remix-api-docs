---
title: MysqlDatabase
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/data-table-mysql/src/lib/database.ts#L14
---
...
A [`Database`](/api/remix/data-table/class/Database/) backed by MySQL.

## Signature

```ts
class MysqlDatabase {
  constructor(input: MysqlDatabaseInput, options: MysqlDatabaseOptions): MysqlDatabase
  ...
  transaction<result>(callback: (database: Database<"mysql">) => Promise<result>, options: TransactionOptions): Promise<result>
