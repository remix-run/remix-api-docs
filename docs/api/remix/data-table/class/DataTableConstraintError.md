...
<a href="https://github.com/remix-run/remix/blob/remix@3.0.0-alpha.3/packages/data-table/src/lib/errors.ts#L103" target="_blank">View Source</a>
...
```ts
class DataTableConstraintError {
  constructor(
    message: string,
