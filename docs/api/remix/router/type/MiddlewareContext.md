...
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/fetch-router/src/lib/middleware.ts#L46
---
...
```ts
type MiddlewareContext<middleware, context> = number extends middleware['length']
  ? context
