---
title: LoggerOptions
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/logger-middleware/src/lib/logger.ts#L24
---
...
Options for the [`logger`](/api/remix/middleware/logger/function/logger/) middleware.
