---
title: MatcherResourceError
source: https://github.com/remix-run/remix/blob/remix@3.0.0-beta.10/packages/route-pattern/src/lib/match/limits.ts#L26
---
...
```ts
class MatcherResourceError {
  constructor(details: MatcherResourceErrorDetails): MatcherResourceError
