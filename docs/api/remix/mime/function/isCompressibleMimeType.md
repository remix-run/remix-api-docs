...
<a href="https://github.com/remix-run/remix/blob/main/packages/mime/src/lib/is-compressible-mime-type.ts#L19" target="_blank">View Source</a>
...
- MIME types explicitly registered as compressible via
  import('./define-mime-type.ts').defineMimeType
