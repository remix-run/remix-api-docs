import { css, createElement } from "/assets/pkg/ui/src/index.js";
import { spring } from "/assets/pkg/ui/src/animation/index.js";
import * as accordion from "/assets/pkg/ui/src/accordion/primitives.js";
...
const accordionTriggerCss = css({
	...
	textAlign: "left",
	"&:hover:not(:disabled)": { backgroundColor: styles.surface.lvl1 },
...
export function AccordionItem(handle) {
	return () => {
		...
		return /* @__PURE__ */ _jsx(accordion.ItemContext, {
			disabled,
			value,
			children: /* @__PURE__ */ _jsx("div", {
				...divProps,
	...
	return () => {
		...
		let button = /* @__PURE__ */ _jsxs("button", {
			...
			children: [/* @__PURE__ */ _jsx("span", { children }), indicator === null ? null : /* @__PURE__ */ _jsx("span", {
				...
				mix: indicatorStyle,
				children: indicator ?? /* @__PURE__ */ _jsx(ChevronRightIcon, {})
			})]
		});
