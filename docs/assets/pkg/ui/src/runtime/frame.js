...
import { Frame, createFrameHandle } from "/assets/pkg/ui/src/runtime/component.js";
import { createComponentErrorEvent, getComponentError } from "/assets/pkg/ui/src/runtime/error-event.js";
import { invariant } from "/assets/pkg/ui/src/runtime/invariant.js";
import { createRangeRoot, createRoot } from "/assets/pkg/ui/src/runtime/vdom.js";
import { diffNodes } from "/assets/pkg/ui/src/runtime/diff-dom.js";
import { createStyleManager } from "/assets/pkg/ui/src/style/index.js";
import { findFlushMarker } from "/assets/pkg/ui/src/runtime/stream-protocol.js";
...
export function createFrame(root, init) {
	...
	async function render(content, options) {
		...
		if (typeof content === "string") {
			...
			if (flushed.applied) {
				if (flushed.remainder !== "") {
					await render(flushed.remainder, {
						...options,
						flushKind: "fragment"
					});
				}
		...
		let isFullDocumentReload = container.root instanceof Document && htmlContent !== undefined && options?.flushKind === "document";
...
function hydrateRegion(vElement, start, end, context) {
	...
	Object.defineProperty(start, "$rmx", {
		value: root,
		enumerable: false
	});
