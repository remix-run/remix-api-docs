import { css, ref } from "/assets/pkg/ui/src/index.js";
import button from "/assets/pkg/ui/src/button/index.js";
import * as menu from "/assets/pkg/ui/src/menu/primitives.js";
import { CheckIcon, ChevronDownIcon, ChevronRightIcon } from "/assets/pkg/ui/src/shared/icons.js";
import { popoverSurfaceStyle } from "/assets/pkg/ui/src/shared/listbox-popover-styles.js";
...
const menuPopoverCss = css({
	"&[data-menu-submenu=\"true\"][data-anchor-placement^=\"right\"]": { marginLeft: `calc(${styles.space.xs} * -1)` },
	"&[data-menu-submenu=\"true\"][data-anchor-placement^=\"left\"]": { marginLeft: styles.space.xs },
...
const menuItemCss = css({
	...
	"&:focus": { outline: "none" },
	"&[data-highlighted=\"true\"]": { color: styles.colors.action.primary.foreground },
	"&[data-highlighted=\"true\"]::before": { backgroundColor: styles.colors.action.primary.background },
	"&[aria-haspopup=\"menu\"][aria-expanded=\"true\"]:not(:focus)": { color: styles.colors.text.primary },
	"&[aria-haspopup=\"menu\"][aria-expanded=\"true\"]:not(:focus)::before": { backgroundColor: styles.surface.lvl2 },
	"&[data-submenu-state=\"selecting\"], &[data-submenu-state=\"dismissing\"]": { color: styles.colors.text.primary },
	"&[data-submenu-state=\"selecting\"]::before, &[data-submenu-state=\"dismissing\"]::before": { backgroundColor: styles.surface.lvl2 },
	"&[data-menu-flash=\"true\"]": { color: styles.colors.text.primary },
		...
		return /* @__PURE__ */ _jsxs(menu.Context, {
			...
			children: [/* @__PURE__ */ _jsxs("button", {
				...
				children: [/* @__PURE__ */ _jsx("span", {
					mix: menuButtonLabelCss,
					children: label
				}), /* @__PURE__ */ _jsx(ChevronDownIcon, { mix: menuButtonIconCss })]
...
export function MenuItem(handle) {
	return () => {
		...
		return /* @__PURE__ */ _jsxs("div", {
			...
			children: [/* @__PURE__ */ _jsx("span", {
				mix: itemSlotStyle,
				children: /* @__PURE__ */ _jsx(CheckIcon, { mix: itemIndicatorStyle })
			}), /* @__PURE__ */ _jsx("span", {
				mix: itemLabelStyle,
		...
		return /* @__PURE__ */ _jsxs(menu.Context, {
			...
			children: [/* @__PURE__ */ _jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ _jsx(ChevronRightIcon, { mix: triggerIndicatorStyle })
				]
			}), /* @__PURE__ */ _jsx(MenuList, {
				...listProps,
				children
