...
const itemCss = css({
	...
	"&[hidden]": { display: "none" },
	"&[data-listbox-flash=\"true\"], &[data-select-flash=\"true\"], &[data-combobox-flash=\"true\"]": { color: styles.colors.text.primary },
	"&[data-listbox-flash=\"true\"]::before, &[data-select-flash=\"true\"]::before, &[data-combobox-flash=\"true\"]::before": { backgroundColor: "transparent" },
	"&[aria-selected=\"true\"]": { "--rmx-listbox-option-indicator-opacity": "1" }
});
