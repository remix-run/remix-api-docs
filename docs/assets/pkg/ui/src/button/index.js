...
const ghostStyle = css({
	...
	color: "#101010",
	textShadow: "none",
	"&:hover:not(:disabled):not([aria-disabled=\"true\"])": { background: "rgba(16, 16, 16, 0.05)" },
	"&:active:not(:disabled):not([aria-disabled=\"true\"]), &[aria-pressed=\"true\"]:not(:disabled):not([aria-disabled=\"true\"])": { background: "rgba(16, 16, 16, 0.08)" }
});
const sizeStyles = {
	md: mediumStyle,
	lg: largeStyle
