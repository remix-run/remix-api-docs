...
import * as tabs from "/assets/pkg/ui/src/tabs/primitives.js";
import { jsx as _jsx } from "/assets/pkg/ui/src/jsx-runtime.js";
export { TabsChangeEvent, onTabsChange } from "/assets/pkg/ui/src/tabs/primitives.js";
...
const tabsTabCss = css({
	...
	"&[data-state=\"inactive\"]:active:not(:disabled):not([aria-disabled=\"true\"])": { background: "rgba(16, 16, 16, 0.08)" },
	"&[data-state=\"active\"]": {
	...
	"&[data-state=\"active\"]:hover:not(:disabled):not([aria-disabled=\"true\"])": { background: tabSliderBackground },
	"&[data-state=\"active\"]:active:not(:disabled):not([aria-disabled=\"true\"])": { background: tabSliderBackground },
...
export function Tabs(handle) {
	return () => {
		...
		return /* @__PURE__ */ _jsx(tabs.Context, {
			activeTab,
			defaultActiveTab,
			disabled,
			onActiveTabChange,
