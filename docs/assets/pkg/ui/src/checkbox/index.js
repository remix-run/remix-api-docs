...
const checkboxDefaultAttrs = createMixin((handle, hostType) => (state, props) => {
	let stateProps = state === undefined ? props : {
		...props,
...
const baseStyle = css({
	...
	[`&:active${enabledSelector}`]: { boxShadow: "0 1px 1px -0.5px rgba(0, 0, 0, 0.06), 0 0 0 1px rgba(0, 0, 0, 0.14), inset 0 1px 2px rgba(0, 0, 0, 0.08)" },
	[`${checkedActiveSelector}, ${mixedActiveSelector}`]: { boxShadow: "0 1px 1px -0.5px rgba(9, 68, 190, 0.1), 0 2px 2px -1px rgba(9, 68, 190, 0.1), 0 4px 4px -2px rgba(9, 68, 190, 0.1), 0 6px 8px -4px rgba(9, 68, 190, 0.1), 0 2px 6px rgba(53, 115, 246, 0.32), inset 0 1px 2px rgba(0, 0, 0, 0.3), inset 0 0 3px 1px rgba(0, 0, 0, 0.12)" },
	"&:focus-visible": {
		outline: 0,
