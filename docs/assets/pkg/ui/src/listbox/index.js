import { attrs, createMixin, on } from "/assets/pkg/ui/src/index.js";
import { hiddenTypeahead, matchNextItemBySearchText } from "/assets/pkg/ui/src/shared/typeahead.js";
import { flashAttribute } from "/assets/pkg/ui/src/listbox/flash-attribute.js";
		...
		navigate(strategy) {
			...
			switch (strategy) {
				case "next":
					...
					break;
				case "previous":
					option = activeIndex === -1 ? interactableOptions[interactableOptions.length - 1] : interactableOptions[activeIndex - 1];
					break;
				case "first":
