...
import { hiddenTypeahead } from "/assets/pkg/ui/src/shared/typeahead.js";
...
import { onKeyDown } from "/assets/pkg/ui/src/select/keydown.js";
...
function SelectProvider(handle) {
	...
	return () => {
		...
		return /* @__PURE__ */ _jsx(listbox.Context, {
			flashSelection: true,
			ref: (nextListboxRef) => {
