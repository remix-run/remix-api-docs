...
import * as listbox from "/assets/pkg/remix/node_modules/@remix-run/ui/src/components/listbox/listbox.js";
...
import { hiddenTypeahead } from "/assets/pkg/remix/node_modules/@remix-run/ui/src/interactions/typeahead/typeahead-mixin.js";
import { onKeyDown } from "/assets/pkg/remix/node_modules/@remix-run/ui/src/interactions/keydown/keydown.js";
...
function SelectProvider(handle) {
	...
	async function settleSelectedOption() {
		...
		await wait(LABEL_SWAP_DELAY_MS);
...
const selectTriggerCss = css({
	...
	"&:active": { backgroundColor: theme.surface.lvl3 },
	"&:focus-visible": {
		...
		return /* @__PURE__ */ _jsxs(select.Context, {
			...
			children: [
				/* @__PURE__ */ _jsxs("button", {
					...
					children: [/* @__PURE__ */ _jsx(SelectLabel, {}), /* @__PURE__ */ _jsx(Glyph, {
	...
	return () => {
		...
		return /* @__PURE__ */ _jsxs("div", {
			...
			children: [/* @__PURE__ */ _jsx(Glyph, {
				...
				children: children ?? handle.props.label
			})]
		});
	};
}