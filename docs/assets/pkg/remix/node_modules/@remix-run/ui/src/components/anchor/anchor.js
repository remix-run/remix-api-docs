...
export function anchor(floating, anchorElement, options = {}) {
	...
	function updatePosition(anchorRect = anchorElement.getBoundingClientRect(), naturalDimensions = getFloatingDimensions(floating, relativeTo, { ignoreInlineMaxSize: true })) {
