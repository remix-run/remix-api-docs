import{css as e}from"/assets/pkg/remix/src/ui.@UKsfrR.js";import{jsx as t,jsxs as n}from"/assets/pkg/remix/src/ui/jsx-runtime.@C-Vxpy.js";export function ColorInterpolation(){return()=>n(`div`,{mix:[e({display:`flex`,gap:30,alignItems:`center`,justifyContent:`center`})],children:[t(`style`,{children:`
          @property --color-t {
            syntax: '<number>';
            inherits: false;
            initial-value: 0;
