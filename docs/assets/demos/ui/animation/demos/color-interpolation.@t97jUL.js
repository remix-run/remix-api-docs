import{css as e}from"/assets/pkg/remix/src/ui.@B4zhQf.js";import{jsx as t,jsxs as n}from"/assets/pkg/remix/src/ui/jsx-runtime.@ZuGnC_.js";export function ColorInterpolation(){return()=>n(`div`,{mix:[e({display:`flex`,gap:30,alignItems:`center`,justifyContent:`center`})],children:[t(`style`,{children:`
          @property --color-t {
            syntax: '<number>';
            inherits: false;
            initial-value: 0;
