...
export function HoldToConfirm(handle) {
	...
	return () => /* @__PURE__ */ _jsxs("div", {
		...
		children: [!confirmed && /* @__PURE__ */ _jsx(HoldButton, { onConfirm: () => {
			confirmed = true;
			handle.update();
		} }, "hold-button"), confirmed && /* @__PURE__ */ _jsx(Confirmation, { onReset: () => {
			confirmed = false;
			handle.update();
		} }, "confirmed")]
	});
	...
	return () => /* @__PURE__ */ _jsxs("button", {
		...
		children: [/* @__PURE__ */ _jsx("div", {
			...
			style: {
				...
				transition: confirming ? `transform ${PRESS_CONFIRM_TIME}ms linear` : `transform ${spring({
					duration: 100,
					bounce: 0
				})}`
			}
			...
			children: [/* @__PURE__ */ _jsx(TrashIcon, {}), "Hold to Delete"]
		})]
	});
}
function Confirmation(handle) {
	return () => /* @__PURE__ */ _jsxs("div", {
		mix: [animateEntrance(confirmationEnterAnimation), css({
			display: "flex",
		...
		children: [/* @__PURE__ */ _jsxs("div", {
			...
			children: [/* @__PURE__ */ _jsx(CheckIcon, {}), "Deleted"]
...
function TrashIcon() {
	return () => /* @__PURE__ */ _jsxs("svg", {
		...
		children: [/* @__PURE__ */ _jsx("polyline", { points: "3 6 5 6 21 6" }), /* @__PURE__ */ _jsx("path", { d: "M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" })]
	});
}
function CheckIcon() {
	return () => /* @__PURE__ */ _jsx("svg", {
		...
		strokeLinecap: "round",
		strokeLinejoin: "round",
		children: /* @__PURE__ */ _jsx("polyline", { points: "20 6 9 17 4 12" })
	});
}
const PRESS_CONFIRM_TIME = 2e3;
...
const baseConfirmPress = createMixin((handle) => {
	...
	return (props) => /* @__PURE__ */ _jsx(handle.element, {
		...props,
		mix: [
