...
import { Combobox, ComboboxOption } from "/assets/pkg/remix/src/ui/combobox.js";
import { onComboboxChange } from "/assets/pkg/remix/src/ui/combobox/primitives.js";
...
export default function Example(handle) {
	...
	return () => /* @__PURE__ */ _jsxs("div", {
		...
		children: [/* @__PURE__ */ _jsxs("div", {
			...
			children: [
				/* @__PURE__ */ _jsx("label", {
					for: "airport-combobox",
					mix: labelCss,
					children: "Airport"
				}),
				/* @__PURE__ */ _jsx(Combobox, {
					inputId: "airport-combobox",
					mix: [comboboxCss, onComboboxChange((event) => {
						value = event.value;
						void handle.update();
					})],
					name: "airport",
					placeholder: "Search airports or codes",
					children: airportOptions.map((airport) => /* @__PURE__ */ _jsx(ComboboxOption, {
				...
				/* @__PURE__ */ _jsx("div", {
					mix: helpCss,
					children: "Try typing `san`, `wash`, or airport codes like `ord`, `lax`, or `jfk`, then use ArrowDown and Enter."
				})
			]
		}), /* @__PURE__ */ _jsx("p", {
			mix: valueCss,
...
const comboboxCss = css({ width: "16rem" });
const stackCss = css({
	display: "flex",
