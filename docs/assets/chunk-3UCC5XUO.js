...
// ../packages/interaction/src/lib/interaction.ts
...
function clientEntry(href, component) {
...
// ../packages/component/src/lib/layout-animation.ts
var LAYOUT_DEFAULTS = {
  duration: 200,
  easing: "ease-out"
};
...
// ../packages/component/src/lib/presence.ts
...
function createRangeRoot([start, end], options = {}) {
  ...
  return Object.assign(eventTarget, {
    ...
    dispose() {
      ...
      let current = vroot;
      vroot = null;
      scheduler.enqueueTasks([() => remove(current, container, scheduler, styles)]);
      scheduler.dequeue();
    },
    flush() {
      scheduler.dequeue();
...
function createFrame(root, init) {
  let container = createContainer2(root);
  let observers = [];
  let subscriptions = [];
...
function createContainer2(root) {
